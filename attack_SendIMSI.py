...
# Form implementation generated from reading ui file 'attack_SendIMSI.ui'
#
...
"")
        ...
        self.local_gt.setGeometry(QtCore.QRect(200, 270, 311, 41))
        self.local_gt.setObjectName("local_gt")
        self.label_8 = QtWidgets.QLabel(self.centralwidget)
        self.label_8.setGeometry(QtCore.QRect(0, 270, 181, 31))
        self.label_8.setStyleSheet("font: 16pt \"Noto Sans\";")
        self.label_8.setObjectName("label_8")
        self.run = QtWidgets.QPushButton(self.centralwidget)
        self.run.setGeometry(QtCore.QRect(399, 330, 191, 41))
        self.run.setObjectName("run")
        self.label_13 = QtWidgets.QLabel(self.centralwidget)
        self.label_13.setGeometry(QtCore.QRect(450, 380, 181, 31))
        self.label_13.setStyleSheet("font: 16pt \"Noto Sans\";")
        self.label_13.setObjectName("label_13")
        self.output = QtWidgets.QTextEdit(self.centralwidget)
        self.output.setGeometry(QtCore.QRect(-40, 410, 1181, 191))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Attacker_SendIMSI"))
    ...
    def runing(self):
        ...
        atck_gui.attack_SendIMSI(client_ip,client_port,server_ip,server_port,Network_Indicator,Targer_MSISDN,locael_GT)
