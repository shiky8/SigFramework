...
# Form implementation generated from reading ui file 'simulator_SendIMSI.ui'
#
...
"")
        ...
        self.label_11.setGeometry(QtCore.QRect(-20, 250, 1151, 20))
        self.label_11.setObjectName("label_11")
        self.msisdn = QtWidgets.QLineEdit(self.centralwidget)
        self.msisdn.setGeometry(QtCore.QRect(200, 210, 311, 41))
        self.msisdn.setObjectName("msisdn")
        self.label_6 = QtWidgets.QLabel(self.centralwidget)
        self.label_6.setGeometry(QtCore.QRect(0, 210, 181, 31))
        self.label_6.setStyleSheet("font: 16pt \"Noto Sans\";")
        self.label_6.setObjectName("label_6")
        self.tableView = QtWidgets.QTableView(self.centralwidget)
        self.tableView.setGeometry(QtCore.QRect(0, 270, 531, 261))
        self.tableView.setObjectName("tableView")
        self.label_7 = QtWidgets.QLabel(self.centralwidget)
        self.label_7.setGeometry(QtCore.QRect(210, 290, 181, 31))
        self.label_7.setStyleSheet("font: 16pt \"Noto Sans\";")
        self.label_7.setObjectName("label_7")
        self.local_gt = QtWidgets.QLineEdit(self.centralwidget)
        self.local_gt.setGeometry(QtCore.QRect(210, 400, 311, 41))
        self.local_gt.setObjectName("local_gt")
        self.label_8 = QtWidgets.QLabel(self.centralwidget)
        self.label_8.setGeometry(QtCore.QRect(10, 400, 181, 31))
        self.label_8.setStyleSheet("font: 16pt \"Noto Sans\";")
        self.label_8.setObjectName("label_8")
        self.tableView_2 = QtWidgets.QTableView(self.centralwidget)
        self.tableView_2.setGeometry(QtCore.QRect(560, 270, 531, 261))
        self.tableView_2.setObjectName("tableView_2")
        self.label_10 = QtWidgets.QLabel(self.centralwidget)
        self.label_10.setGeometry(QtCore.QRect(560, 400, 181, 31))
        self.label_10.setStyleSheet("font: 16pt \"Noto Sans\";")
        self.label_10.setObjectName("label_10")
        self.imsi = QtWidgets.QLineEdit(self.centralwidget)
        self.imsi.setGeometry(QtCore.QRect(740, 390, 311, 41))
        self.imsi.setObjectName("imsi")
        self.label_12 = QtWidgets.QLabel(self.centralwidget)
        self.label_12.setGeometry(QtCore.QRect(770, 290, 181, 31))
        self.label_12.setStyleSheet("font: 16pt \"Noto Sans\";")
        self.label_12.setObjectName("label_12")
        self.run = QtWidgets.QPushButton(self.centralwidget)
        self.run.setGeometry(QtCore.QRect(439, 540, 191, 41))
        self.run.setObjectName("run")
        self.label_13 = QtWidgets.QLabel(self.centralwidget)
        self.label_13.setGeometry(QtCore.QRect(490, 590, 181, 31))
        self.label_13.setStyleSheet("font: 16pt \"Noto Sans\";")
        self.label_13.setObjectName("label_13")
        self.output = QtWidgets.QTextEdit(self.centralwidget)
        self.output.setGeometry(QtCore.QRect(0, 620, 1181, 191))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "simulator_SendIMSI"))
        ...
        self.msisdn.setText(_translate("MainWindow", "(i.e 201512345678)"))
        self.label_6.setText(_translate("MainWindow", "Targer_MSISDN"))
        self.label_7.setText(_translate("MainWindow", "Attacker"))
        self.local_gt.setText(_translate("MainWindow", "(i.e 999599)"))
        self.label_8.setText(_translate("MainWindow", "locael_GT"))
        self.label_10.setText(_translate("MainWindow", "Target_IMSI"))
    ...
    def runing(self):
        ...
        locael_GT = str(self.local_gt.text()).replace(")","").replace("(","")
